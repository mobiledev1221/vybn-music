...
export default class Slider extends PureComponent {
  ...
  render() {
    ...
    const thumbLeft = value.interpolate({
      ...
      outputRange: I18nManager.isRTL
        ? [2, -(containerSize.width - thumbSize.width + 2)]
        : [-4, containerSize.width - thumbSize.width + 4],
      // extrapolate: 'clamp',
    });
    ...
    const maximumTrackWidth = Animated.subtract(new Animated.Value(maximumValue), value).interpolate({
      inputRange: [0, maximumValue - minimumValue],
      outputRange: [0, containerSize.width - thumbSize.width],
      // extrapolate: 'clamp',
    });
      ...
      >
        ...
        >
          <ImageBackground
            ...
            style={{ 
              width: "100%",
              height: trackStyle.height ? trackStyle.height - 2 : 13,
              flexDirection: "row-reverse"
            }}
            imageStyle={{
              borderRadius: trackStyle.borderRadius ? trackStyle.borderRadius : 6
            }}
          >
            <Animated.View
              style={{
                backgroundColor: maximumTrackTintColor,
                height: 11,
                width: Animated.add(maximumTrackWidth, thumbSize.width / 2),
              }}
            />
          </ImageBackground>
        </View>
  ...
  _renderThumbImage = () => {
    ...
    return <Image source={thumbImage} resizeMode="stretch" style={{width: "100%", height: "100%"}} />;
  };
}
